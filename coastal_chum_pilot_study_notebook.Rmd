...
a <- ggplot(data = snp_pcs)+geom_point(aes(Axis1, Axis2, color = basin, shape = basin), alpha = 0.7, size =2) + stat_ellipse(aes(Axis1, Axis2, color = basin)) +theme_classic()+scale_color_scico_d(name= "Basin")+xlab("PC1\n2.1% of variance")+ylab("PC1\n1.7% of variance")+  scale_shape_discrete(name = "Basin")+ theme(legend.text=element_text(size=2))
