...
raw_genos %<>%
  ...
  dplyr::dplyr::select(Sample, `Raw Reads`, `On-Target Reads`, `%On-Target`, `%GT`, IFI)

shared_genos <- raw_genos %>%
  inner_join(dplyr::dplyr::select(test_run_genos,Sample, `Raw Reads`, `On-Target Reads`, `%On-Target`, `%GT`, IFI), by = c("Sample" = "Sample"))
